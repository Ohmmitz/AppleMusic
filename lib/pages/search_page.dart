    ...
    return Scaffold(
          ...
          Container(
            ...
            child: IconButton(
                ...
                icon: Icon(
                  ...
                  color:Color.fromARGB(255, 255, 60, 68),
                  size: 40,
                )),
          )
        ],
      ...
      body: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'ศิลปิน, เพลง , เนื้อเพลง และอื่นๆ',
                      hintStyle: TextStyle(
                          color: Colors.grey,
                          fontSize: 20,
          ...
          Container(
            height: 567 - 0, //may need to adjust acordingly
            child: GridView.builder(
              itemCount: BrowseCat.length,
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 2, // number of Rows in the grid
                childAspectRatio: 1.5, // ratio of Row width to row height
              ),
